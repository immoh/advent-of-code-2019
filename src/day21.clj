...
(defn create-input-seq [cmds]
  (mapcat (partial map int) (concat (interpose "\n" cmds) ["\n"])))

(defn visualize [output]
  (println (reduce str (map char output))))
...
(defn part1 [input]
  (run-program {:program       (parse-input input)
                :inputs        (create-input-seq ["NOT A J"
                                                  "NOT B T"
                                                  "OR T J"
                                                  "NOT C T"
                                                  "OR T J"
